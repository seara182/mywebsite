...
function BlobPhoto({
  ...
  return /*#__PURE__*/React.createElement("figure", {
    ...
    style: {
      ...
      borderRadius: blob,
      boxShadow: "0 10px 26px -12px rgba(22,20,15,0.42), 0 30px 60px -30px rgba(22,20,15,0.4)"
    }
...
function FigurePlot({
  ...
  return /*#__PURE__*/React.createElement("figure", {
    ...
    style: {
      ...
      boxShadow: "0 10px 26px -14px rgba(22,20,15,0.3), 0 36px 70px -40px rgba(188,90,55,0.4)",
      maxWidth: width + 56
    }
...
function TimelineEntry({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      boxShadow: accent ? "0 0 0 5px rgba(188,90,55,0.14)" : "0 0 0 5px var(--paper-2)",
      marginTop: 5,
      flex: "none"
    }
    ...
    style: {
      ...
      color: "var(--text-body)",
      fontWeight: 500,
      marginBottom: points.length ? 12 : 0
    }
