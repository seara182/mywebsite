  ...
  var TRANSLATIONS = {
    de: {
      ...
      projects: {
        ...
        description: "CheapSeats ist ein Desktop-Scoreboard für Windows, das beliebige der 32 NFL- und 30 MLB-Teams verfolgt. Es zeigt den Live-Spielstand eines laufenden Spiels und den Anstoß des nächsten, mit Links zu Highlight-Clips der offiziellen Liga-YouTube-Kanäle. Die Daten stammen aus der öffentlichen JSON-API von ESPN; Teamauswahl und ein Spielstand-Cache werden lokal gespeichert, sodass beim Start der letzte bekannte Stand erscheint. Die Oberfläche ist auf Englisch und Deutsch, ohne Konto und ohne Telemetrie.",
      ...
      sports: {
        nav: { features: "Funktionen", deepDive: "Einblicke", mobile: "Mobil", tech: "Technik" },
        ...
        githubBtn: "Bald im Microsoft Store", backFooter: "Zurück zur Startseite", madeByFooter: "CheapSeats · Made by Mika",
    ...
    en: {
      ...
      sports: {
        nav: { features: "Features", deepDive: "Close-ups", mobile: "Mobile", tech: "Tech" },
        ...
        githubBtn: "Coming soon to Microsoft Store", backFooter: "Back to home", madeByFooter: "CheapSeats · Made by Mika",
    ...
    fr: {
      ...
      projects: {
        ...
        description: "CheapSeats est un tableau de bord de bureau pour Windows qui suit n'importe laquelle des 32 équipes NFL et 30 équipes MLB de votre choix. Il affiche le score en direct d'un match en cours et l'heure du prochain, avec des liens vers des extraits vidéo des chaînes YouTube officielles des ligues. Les données proviennent de l'API JSON publique d'ESPN ; la sélection d'équipe et un cache des scores sont stockés localement, si bien que le dernier état connu apparaît au lancement. L'interface est en anglais et en allemand, sans compte ni télémétrie.",
      ...
      sports: {
        nav: { features: "Fonctions", deepDive: "Aperçus", mobile: "Mobile", tech: "Technique" },
        ...
        githubBtn: "Bientôt sur le Microsoft Store", backFooter: "Retour à l'accueil", madeByFooter: "CheapSeats · Made by Mika",
    ...
    es: {
      ...
      sports: {
        nav: { features: "Funciones", deepDive: "Detalles", mobile: "Móvil", tech: "Técnica" },
        ...
        githubBtn: "Próximamente en Microsoft Store", backFooter: "Volver al inicio", madeByFooter: "CheapSeats · Made by Mika",
    ...
    it: {
      ...
      projects: {
        ...
        description: "CheapSeats è un tabellone da scrivania per Windows che segue una qualsiasi delle 32 squadre NFL e 30 MLB che scegli. Mostra il punteggio in diretta di una partita in corso e l'orario di inizio della prossima, con link ai video degli highlight dei canali YouTube ufficiali delle leghe. I dati provengono dall'API JSON pubblica di ESPN; la selezione delle squadre e una cache dei punteggi sono salvate localmente, così all'avvio compare l'ultimo stato noto. L'interfaccia è in inglese e tedesco, senza account e senza telemetria.",
      ...
      sports: {
        nav: { features: "Funzioni", deepDive: "Dettagli", mobile: "Mobile", tech: "Tecnica" },
        ...
        githubBtn: "Presto su Microsoft Store", backFooter: "Torna alla home", madeByFooter: "CheapSeats · Made by Mika",
