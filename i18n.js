  ...
  var TRANSLATIONS = {
    de: {
      ...
      projects: {
        ...
        description: "Eine App für Desktop und Handy, die den Stand zweier Lieblingsteams aus NFL und MLB auf einen Blick zeigt: Spiele, Tabelle, Kader, Geschichte. Gebaut für den kurzen Blick beim Hochfahren — der Cache zeigt sofort Daten und aktualisiert im Hintergrund. Ich wollte zum ersten Mal eine externe API anbinden und plattformübergreifend entwickeln.",
    ...
    en: {
      ...
      projects: {
        ...
        description: "An app for desktop and phone that shows the state of two favourite NFL and MLB teams at a glance: games, standings, roster, history. Built for a quick look at start-up — the cache shows data instantly and refreshes in the background. I wanted to connect to an external API for the first time and develop cross-platform.",
    ...
    fr: {
      ...
      projects: {
        ...
        description: "Une application pour ordinateur et téléphone qui montre d’un coup d’œil l’état de deux équipes favorites de NFL et de MLB : matchs, classement, effectif, histoire. Conçue pour le regard rapide au démarrage — le cache affiche les données aussitôt et se met à jour en arrière-plan. Je voulais pour la première fois brancher une API externe et développer en multiplateforme.",
    ...
    es: {
      ...
      projects: {
        ...
        description: "Una app para ordenador y móvil que muestra de un vistazo el estado de dos equipos favoritos de la NFL y la MLB: partidos, clasificación, plantilla, historia. Pensada para el vistazo rápido al arrancar — la caché muestra datos al instante y se actualiza en segundo plano. Quería conectar por primera vez una API externa y desarrollar multiplataforma.",
    ...
    it: {
      ...
      projects: {
        ...
        description: "Un’app per computer e telefono che mostra a colpo d’occhio la situazione di due squadre preferite di NFL e MLB: partite, classifica, rosa, storia. Pensata per lo sguardo rapido all’avvio — la cache mostra subito i dati e si aggiorna in background. Volevo per la prima volta collegare un’API esterna e sviluppare multipiattaforma.",
