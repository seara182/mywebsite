  ...
  var TRANSLATIONS = {
    de: {
      ...
      footer: {
        ...
        disclaimer: "Übersetzungen werden als Komfortfunktion bereitgestellt, wurden teilweise KI-unterstützt erstellt und von mir inhaltlich geprüft. Maßgeblich ist die deutsche Fassung.",
    ...
    en: {
      ...
      footer: {
        ...
        disclaimer: "Translations are provided as a convenience feature, were created in part with AI assistance, and were reviewed by the author. The German version is authoritative.",
    ...
    fr: {
      ...
      footer: {
        ...
        disclaimer: "Les traductions sont proposées par souci de confort, ont été réalisées en partie avec l'aide de l'IA et relues par l'auteur. La version allemande fait foi.",
    ...
    es: {
      ...
      footer: {
        ...
        disclaimer: "Las traducciones se ofrecen como función de comodidad, se han elaborado en parte con ayuda de IA y han sido revisadas por el autor. La versión alemana es la vinculante.",
    ...
    it: {
      ...
      footer: {
        ...
        disclaimer: "Le traduzioni sono fornite come funzione di comodità, sono state realizzate in parte con l'ausilio dell'IA e riviste dall'autore. Fa fede la versione tedesca.",
